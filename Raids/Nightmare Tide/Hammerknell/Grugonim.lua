...
function GR:InitVars()	
	...
	KBMNTGR_Settings = self.Settings
	chKBMNTGR_Settings = self.Settings
end

function GR:SwapSettings(bool)
	if bool then
		KBMNTGR_Settings = self.Settings
		self.Settings = chKBMNTGR_Settings
	else
		chKBMNTGR_Settings = self.Settings
		self.Settings = KBMNTGR_Settings
	end
end

function GR:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMNTGR_Settings, self.Settings)
	else
		KBM.LoadTable(KBMNTGR_Settings, self.Settings)
	end
