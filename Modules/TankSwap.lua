...
function KBM.TankSwap:Pull()
	...
	if #self.TankStore > 0 then
		...
		for i = 1, 4 do
			...
			GUI.DebuffFrame[i].Shadow:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
			...
			GUI.DebuffFrame[i].Text:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
			...
			GUI.DeCool[i].Text:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
			GUI.DeCool[i].Shadow:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
		...
		function GUI:SetTank(Text)
			self.TankShadow:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
			self.TankShadow:SetText(Text)
			self.TankText:SetFont(AddonIni.identifier, "font/Montserrat-Bold.otf")
