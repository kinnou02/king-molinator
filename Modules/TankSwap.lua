...
function KBM.TankSwap:Pull()
	...
	if #self.TankStore > 0 then
		...
		for i = 1, 4 do
			...
			GUI.DebuffFrame[i].Shadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
			...
			GUI.DebuffFrame[i].Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
			...
			GUI.DeCool[i].Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
			GUI.DeCool[i].Shadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
		...
		function GUI:SetTank(Text)
			self.TankShadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
			self.TankShadow:SetText(Text)
			self.TankText:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
