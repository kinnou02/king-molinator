...
function KBM.PhaseMonitor:PullObjective()
	...
	if #self.ObjectiveStore > 0 then
		...
		GUI.Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
		GUI.Text:SetLayer(3)
		...
		GUI.ObShadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
		...
		GUI.Objective:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
...
function KBM.PhaseMonitor:Init()
	...
	self.Anchor.Shadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
	...
	self.Frame.Shadow:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
	...
	self.Frame.Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
