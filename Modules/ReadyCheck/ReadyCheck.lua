...
function PI.GUI:Init()
	...
	if (KBM.Options.Font.Custom > 1) then self.HeaderText:SetFont(AddonIni.identifier, KBM.Constant.Font[KBM.Options.Font.Custom][2]) end
			...
			if self[Index].Enabled then
				if self[Index].Unit then
					if self[Index].Unit.Offline then
						...
						self[Index].Columns.Vitality.Text:SetText("-")
						self[Index].Columns.Stone.Text:SetText("-")
						self[Index].Columns.EternalBuffRogue.Text:SetText("?")
						self[Index].Columns.EternalBuffRogue.Text:SetFontColor(0.15, 0.9, 0.15)
						self[Index].Columns.EternalBuffRogue.Text:SetVisible(true)
						self[Index].Columns.EternalBuffRogue.Icon:SetVisible(false)
						self[Index].Columns.EternalBuffPrimalist.Text:SetText("?")
						self[Index].Columns.EternalBuffPrimalist.Text:SetFontColor(0.15, 0.9, 0.15)
						self[Index].Columns.EternalBuffPrimalist.Text:SetVisible(true)
						self[Index].Columns.EternalBuffPrimalist.Icon:SetVisible(false)
						self[Index].Columns.EternalBuffMage.Text:SetText("?")
						self[Index].Columns.EternalBuffMage.Text:SetFontColor(0.15, 0.9, 0.15)
						self[Index].Columns.EternalBuffMage.Text:SetVisible(true)
						self[Index].Columns.EternalBuffMage.Icon:SetVisible(false)
						self[Index].Columns.EternalBuffWarrior.Text:SetText("?")
						self[Index].Columns.EternalBuffWarrior.Text:SetFontColor(0.15, 0.9, 0.15)
						self[Index].Columns.EternalBuffWarrior.Text:SetVisible(true)
						self[Index].Columns.EternalBuffWarrior.Icon:SetVisible(false)
						self[Index].Columns.EternalBuffCleric.Text:SetText("?")
						self[Index].Columns.EternalBuffCleric.Text:SetFontColor(0.15, 0.9, 0.15)						
						self[Index].Columns.EternalBuffCleric.Text:SetVisible(true)
						self[Index].Columns.EternalBuffCleric.Icon:SetVisible(false)						
					else
	...
	for Row = 1, 40 do
		...
		if Row < 21 then
			...
			if (KBM.Options.Font.Custom > 1) then self.Rows[Row].Text:SetFont(AddonIni.identifier, KBM.Constant.Font[KBM.Options.Font.Custom][2]) end
		...
		for ID, Object in pairs(self.Columns.List) do
			...
			if Row < 21 then
				...
				if (KBM.Options.Font.Custom > 1) then self.Rows[Row].Columns[ID].Text:SetFont(AddonIni.identifier, KBM.Constant.Font[KBM.Options.Font.Custom][2]) end
