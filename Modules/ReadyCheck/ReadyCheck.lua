...
function PI.GUI:Init()
	...
	self.HeaderText:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
	...
	for Row = 1, 40 do
		...
		if Row < 21 then
			...
			self.Rows[Row].Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
		...
		for ID, Object in pairs(self.Columns.List) do
			...
			if Row < 21 then
				...
				self.Rows[Row].Columns[ID].Text:SetFont(AddonIni.identifier, KBM.Options.Font.Custom)
