...
KBMSLEXSBPBSS_Settings = nil
chKBMSLEXSBPBSS_Settings = nil
...
function MOD:InitVars()
	...
	KBMSLEXSBPBSS_Settings = self.Settings
	chKBMSLEXSBPBSS_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMSLEXSBPBSS_Settings = self.Settings
		self.Settings = chKBMSLEXSBPBSS_Settings
	else
		chKBMSLEXSBPBSS_Settings = self.Settings
		self.Settings = KBMSLEXSBPBSS_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMSLEXSBPBSS_Settings, self.Settings)
	else
		KBM.LoadTable(KBMSLEXSBPBSS_Settings, self.Settings)
	end
...
function MOD:DefineMenu()
	self.Menu = Instance.Menu:CreateEncounter(self.Slagstorm, self.Enabled)
end
