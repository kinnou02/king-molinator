...
function MOD:Start()
	...
	self.Alumar.Triggers.Aid = KBM.Trigger:Create("B0A1AAAB1CB1F7161", "buff", self.Alumar)
    self.Alumar.Triggers.Aid:AddAlert(self.Alumar.AlertsRef.Aid)
	
	self.Alumar.Triggers.AidRemove = KBM.Trigger:Create("B0A1AAAB1CB1F7161", "buffRemove", self.Alumar)
