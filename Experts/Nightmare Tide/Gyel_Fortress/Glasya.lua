...
KBMNTGFGLA_Settings = nil
chKBMNTGFGLA_Settings = nil
...
function MOD:InitVars()
	...
	KBMNTGFGLA_Settings = self.Settings
	chKBMNTGFGLA_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMNTGFGLA_Settings = self.Settings
		self.Settings = chKBMNTGFGLA_Settings
	else
		chKBMNTGFGLA_Settings = self.Settings
		self.Settings = KBMNTGFGLA_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMNTGFGLA_Settings, self.Settings)
	else
		KBM.LoadTable(KBMNTGFGLA_Settings, self.Settings)
	end
