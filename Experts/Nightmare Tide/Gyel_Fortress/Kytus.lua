...
KBMNTGFKYT_Settings = nil
chKBMNTGFKYT_Settings = nil
...
function MOD:InitVars()
	...
	KBMNTGFKYT_Settings = self.Settings
	chKBMNTGFKYT_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMNTGFKYT_Settings = self.Settings
		self.Settings = chKBMNTGFKYT_Settings
	else
		chKBMNTGFKYT_Settings = self.Settings
		self.Settings = KBMNTGFKYT_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMNTGFKYT_Settings, self.Settings)
	else
		KBM.LoadTable(KBMNTGFKYT_Settings, self.Settings)
	end
