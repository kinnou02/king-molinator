...
KBMSLNMTOSGTS_Settings = nil
chKBMSLNMTOSGTS_Settings = nil
...
function MOD:InitVars()
	...
	KBMSLNMTOSGTS_Settings = self.Settings
	chKBMSLNMTOSGTS_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMSLNMTOSGTS_Settings = self.Settings
		self.Settings = chKBMSLNMTOSGTS_Settings
	else
		chKBMSLNMTOSGTS_Settings = self.Settings
		self.Settings = KBMSLNMTOSGTS_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMSLNMTOSGTS_Settings, self.Settings)
	else
		KBM.LoadTable(KBMSLNMTOSGTS_Settings, self.Settings)
	end
