...
GH.Lang.Ability.Orb:SetKorean("능력의 보주")
...
GH.Lang.Ability.Rumbling:SetKorean("구르는 대지")
...
GH.Lang.Ability.Toil:SetKorean("대지의 토양")
...
GH.Lang.Verbose.Call:SetFrench("Pop de l'adds")
