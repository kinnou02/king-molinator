...
function ES:Start()	
	...
	self.Estrode.AlertsRef.Rift = KBM.Alert:Create(self.Lang.Ability.Rift[KBM.Lang], nil, true, true, "orange")
	...
	self.Estrode.Triggers.RiftRemove = KBM.Trigger:Create(self.Lang.Ability.Rift[KBM.Lang], "buffRemove", self.Estrode)
	self.Estrode.Triggers.RiftRemove:AddStop(self.Estrode.AlertsRef.Rift)
