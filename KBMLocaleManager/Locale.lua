...
function KBMLM.SetMain_Lang()
	...
	KBM.Language.Options.MechTimerOverride:SetFrench("Timers de Mécanisme: Substituer")
	...
	KBM.Language.Options.MechanicTimers:SetFrench("Timers de Mécanisme")
	...
	KBM.Language.Options.TimersEnabled:SetFrench("Timers activé")
	...
	KBM.Language.Options.Single:SetRussian("Один")
	...
	KBM.Language.Options.Final:SetRussian("Финал")
