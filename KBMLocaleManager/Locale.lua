...
function KBMLM.SetMain_Lang()
	...
	KBM.Language.Options.CastbarOverride:SetGerman("Zauberbalken: Einstellungen")
	...
	KBM.Language.Options.AlertsOverride:SetGerman("Alarmierungs: Einstellungen")
	...
	KBM.Language.Options.AlertsEnabled:SetGerman("Bildschirm Alarmierungen aktiviert")
