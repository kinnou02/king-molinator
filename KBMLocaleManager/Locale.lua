...
function KBMLM.SetMain_Lang()
	...
	KBM.Language.Welcome.Options:SetKorean("옵션은 /kbmoptions 을")
	...
	KBM.Language.RezMaster.Ready:SetKorean("격노!")
	...
	KBM.Language.Command.Reset:SetKorean("/kbmreset -- 현재 인카운터 리셋.")
	...
	KBM.Language.Tabs.Encounter:SetKorean("인카운터")
	...
	KBM.Language.Encounter.Start:SetKorean("인카운터가 시작되었습니다:")
	...
	KBM.Language.Encounter.Wipe:SetKorean("인카운터가 끝났습니다. 아마 전멸했을듯.")
	...
	KBM.Language.Encounter.Victory:SetKorean("인카운터 승리!")
