...
function KBM.InitTabs()
	...
	function KBM.Tabs:Create(Name, Type)	
		...
		KBM.LoadTexture(Tab.Texture, "KingMolinator", "Media/Tabber_Off.png")
		...
		Tab.TextShadow:SetText(KBM.Language.Tabs[Name][KBM.Lang])
		...
		Tab.Text:SetText(KBM.Language.Tabs[Name][KBM.Lang])
		...
		function Tab:Deselect()		
			...
			self.PageSize = 0
			KBM.LoadTexture(self.Texture, "KingMolinator", "Media/Tabber_Off.png")
		...
		function Tab:Select(Open)			
			...
			KBM.LoadTexture(self.Texture, "KingMolinator", "Media/Tabber.png")
...
function KBM.InitOptions()
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Main.Texture, "KingMolinator", "Media/Tabber.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Plug.Texture, "KingMolinator", "Media/Tabber_Off.png")
	...
	KBM.MainWin.Tabs.Plug.Shadow:SetText(KBM.Language.Tabs.Plugins[KBM.Lang])
	...
	KBM.MainWin.Tabs.Plug.Text:SetText(KBM.Language.Tabs.Plugins[KBM.Lang])
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Raid.Icon, "KingMolinator", "Media/Raid_Icon.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Sliver.Texture, "KingMolinator", "Media/Tabber_Off.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Sliver.Icon, "KingMolinator", "Media/Sliver_Icon.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Master.Texture, "KingMolinator", "Media/Tabber_Off.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Master.Icon, "KingMolinator", "Media/Master_Icon.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Expert.Icon, "KingMolinator", "Media/Expert_Icon.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Group.Texture, "KingMolinator", "Media/Tabber_Off.png")
	...
	KBM.LoadTexture(KBM.MainWin.Tabs.Group.Icon, "KingMolinator", "Media/Group_Icon.png")
	...
	function KBM.MainWin.Menu:CreateHeader(Text, Hook, Default, Static, Tab)
		...
		Header.ChildSize = 0
		function Header:CreatePage(Text, Link, Default)
