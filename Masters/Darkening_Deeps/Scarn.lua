...
KBMMMDDSN_Settings = nil
chKBMMMDDSN_Settings = nil
-- Link Mods
...
function MOD:InitVars()
	...
	KBMMMDDSN_Settings = self.Settings
	chKBMMMDDSN_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMMMDDSN_Settings = self.Settings
		self.Settings = chKBMMMDDSN_Settings
	else
		chKBMMMDDSN_Settings = self.Settings
		self.Settings = KBMMMDDSN_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMMMDDSN_Settings, self.Settings)
	else
		KBM.LoadTable(KBMMMDDSN_Settings, self.Settings)
	end
