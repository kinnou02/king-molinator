...
KBMMMCRAZ_Settings = nil
chKBMMMCRAZ_Settings = nil
-- Link Mods
...
function MOD:InitVars()
	...
	KBMMMCRAZ_Settings = self.Settings
	chKBMMMCRAZ_Settings = self.Settings
...
function MOD:SwapSettings(bool)
	...
	if bool then
		KBMMMCRAZ_Settings = self.Settings
		self.Settings = chKBMMMCRAZ_Settings
	else
		chKBMMMCRAZ_Settings = self.Settings
		self.Settings = KBMMMCRAZ_Settings
	end
...
function MOD:LoadVars()	
	if KBM.Options.Character then
		KBM.LoadTable(chKBMMMCRAZ_Settings, self.Settings)
	else
		KBM.LoadTable(KBMMMCRAZ_Settings, self.Settings)
	end
